...
public class TicTacToeFrame extends JFrame {
    ...
    private void createMsgPnl(){
        ...
        msg = new JLabel("<html>Player " + player + ", take your turn.</html>", null, JLabel.CENTER);
    ...
    private void createCntPnl(){
        ...
        xWins.setFont(new Font("Arial", Font.PLAIN, 16));
        ...
        xWinCntField.setFont(new Font("Arial", Font.PLAIN, 18));
        xWinCntField.setEditable(false);

        tieCntLbl = new JLabel("Tie Count", JLabel.CENTER);
        tieCntLbl.setFont(new Font("Arial", Font.PLAIN, 16));
        ...
        tieCntField.setFont(new Font("Arial", Font.PLAIN, 18));
        tieCntField.setEditable(false);

        oWins = new JLabel("Player O Win Count", JLabel.CENTER);
        oWins.setFont(new Font("Arial", Font.PLAIN, 16));
        ...
        oWinCntField.setFont(new Font("Arial", Font.PLAIN, 18));
    ...
    private void createControlPnl(){
        ...
        quitBtn.setFont(new Font("Arial", Font.PLAIN, 25));
        quitBtn.addActionListener((ActionEvent ae) ->{
            int res = JOptionPane.showOptionDialog(null, "Done Already?", "Message", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, img, new Object[]{"Yes", "No"}, JOptionPane.YES_OPTION);
            if(res == JOptionPane.YES_OPTION){
                System.exit(0);
            }
            else if(res == JOptionPane.NO_OPTION){
        ...
        do {
            ...
            for (int row = 0; row <= 2; row++) {
                for (int col = 0; col <= 2; col++) {
                    ...
                    GUIboard[row][col].setFont(new Font("Arial", Font.BOLD, 30));
                    ...
                    GUIboard[row][col].addActionListener(e -> {
                        ...
                        if (!clicked.getText().isBlank()) {
                            JOptionPane.showMessageDialog(frame, "Place taken. Try a valid move.", "[Error] Invalid Input", JOptionPane.ERROR_MESSAGE);
                            return;
                        }
                        ...
                        if (isWin(player)) {
                            int res = JOptionPane.showOptionDialog(frame, "Player " + player +" Wins!\nRematch?", "Results", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, img, new Object[]{"Yes", "No"}, JOptionPane.YES_OPTION);
                            if (res == JOptionPane.YES_OPTION) {
                                again = true;
                            }
                            else if(res == JOptionPane.NO_OPTION) {
                            ...
                            player = "O";
                            msg.setText("<html>Player " + player + ", take your turn.</html>");

                        }
                        if (isTie()) {
                            int res = JOptionPane.showOptionDialog(frame, "Its a draw!\nRematch?", "Results", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, img, new Object[]{"Yes", "No"}, JOptionPane.YES_OPTION);
                            if (res == JOptionPane.YES_OPTION) {
                                again = true;
                            }
                            else if(res == JOptionPane.NO_OPTION){
                            ...
                            player = "O";
                            msg.setText("<html>Player " + player + ", it is your turn.</html>");
                        }
                        if (player.equals("X")) {
                            player = "O";
                        } else {
